...
UPDATE "settings" SET "value" = 'VideoLessons, Subscriptions, UserProfile, Comments, SEO, PayPal' WHERE name = 'site.enabled_plugins';

UPDATE "settings" SET "value" = 'Teamr' WHERE "name" = 'site.name';
