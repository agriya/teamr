...
(function(module) {
    ...
    module.controller('courseFeedbackController', function(CourseFeedback, $scope, $rootScope, $state) {
...
(function(module) {
    ...
    module.controller('ratingButtonController', function($scope, $modal, $rootScope) {
        var model = this;
    ...
    module.controller('ratingController', function($scope, pageType, $rootScope, $location, CourseUsersFeedback, CourseRating, $state, CourseRatingAction, CourseUserDetails, CourseRatingDelete, rating, $filter, TokenServiceData, flash) {
        var model = this;
        if (pageType === "page") {
