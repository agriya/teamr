...
Teamr is an open source online training platform similar to Treehouse Clone script to make websites concerning online training marketplaces. It is written in AngularJS with REST API for high performance in mind.
...
Teamr is an open source online training project. Full commercial support (commercial license, customization, training, etc) are available through [Teamr platform](http://teamr.demo.agriya.com/#!/)
